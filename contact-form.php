...
<head>
    ...
    <meta name="description" content="Show yourself brightly with BPRO - clean and creative portfolio and resume template!">
    <meta name="author" content="ThemesTransmit">

    <!-- Site Title
    ================================================== -->
    <title>BPRO - Personal Resume/vCard Template</title>
...
<body>
    ...
    <div class="left-sidebar">
        <!-- Chat Icon -->
        <a href="#contact" class="message" aria-label="message icon">
    ...
    <header class="header-area">
        ...
        <div class="logo">
            <a href="index.html" aria-label="header logo">
                <img src="assets/img/logo/logo.svg" height="30" width="100" alt="site logo">
            </a>
        </div>
        <!--toggler button-->
    ...
    <main>
        ...
        <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        Contact Message start here
        ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
        <section class="contact_action">
            <div class="container">
                <!-- Section Content -->
                    ...
                    <div class="content">
                        <?php
                            ...
                            // If we passed all previous tests, send the email then redirect to the thank you page.
                                ...
                                ?>
                                    <h1 class="title">Thanks For Contacting Me</h1>
                                    <p>I appreciate that you took the time to send the message. Your Message has been sent to
                                        my Panel.
                                    </p>
                                    <br>
                                    <p>Iam getting back to you very soon.</p>
                                    <br>
                                    <a href="index.html" class="button-home secondary_solid_btn">
                                        Back to Home                            
                                    </a>
                                <?php
                            }
    ...
    <div class="sidebar-menu">
        ...
        <ul class="nav-menu" id="nav">
            ...
            <li>
                <a href="index.html#protfolio" class="nav-link">
                    PROTFOLIO
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="index.html#resume" class="nav-link">
                    RESUME
                </a>
            </li>
            <li>
        ...
        <div class="copyright-content text-center">
            <p>
                Copyright by <a href="#" aria-label="copyright link">@biopro</a>
            </p>
        </div>
    </div>
   <!--~~./ end right sidebar ~~-->
